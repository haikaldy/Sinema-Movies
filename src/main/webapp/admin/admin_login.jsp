...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(135deg, #eb3349 0%, #f45c43 40%, #a445b2 100%);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    ...
    <div class="login-card text-center">
        <h2 class="mb-5 fw-bold">ADMIN LOGIN</h2>

        <form action="<%=request.getContextPath()%>/adminLogin" method="POST">
            
            <div class="mb-3 text-start">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" name="adminEmail" style="border-right: 1px solid #444;" required>
            </div>
